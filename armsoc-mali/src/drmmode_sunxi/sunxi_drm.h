...
enum sunxi_drm_gem_buf_type
{
	...
	SUNXI_BO_WC = 1 << 2,
	SUNXI_BO_MASK = SUNXI_BO_CONTIG | SUNXI_BO_CACHABLE | SUNXI_BO_WC
};
...
#define DRM_IOCTL_SUNXI_FLIP_SYNC		DRM_IOW(DRM_COMMAND_BASE + DRM_SUNXI_FLIP_SYNC, struct sunxi_flip_user_date)
#define DRM_IOCTL_SUNXI_FENCE_SYNC		DRM_IO(DRM_COMMAND_BASE + DRM_SUNXI_FENCE_SYNC)
#define DRM_IOCTL_SUNXI_ROTATE			DRM_IOWR(DRM_COMMAND_BASE + DRM_SUNXI_ROTATE, struct sunxi_rotate_cmd)
#define DRM_IOCTL_SUNXI_SYNC_GEM		DRM_IOW(DRM_COMMAND_BASE + DRM_SUNXI_SYNC_GEM, struct sunxi_sync_gem_cmd)	
#endif
